> **Status: Legacy**  
> **Do not use this file as the product README.**  
> Canonical entry point: [`README.md`](../../README.md).  
> Product constitution: [`docs/PROJECT_BIBLE.md`](../PROJECT_BIBLE.md).  
> This archive preserves the former “AI Quant Signal Platform” dashboard-oriented README for historical comparison. Setup commands and deployment notes may be stale.
