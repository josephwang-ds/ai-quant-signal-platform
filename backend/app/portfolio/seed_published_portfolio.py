"""Operator CLI for Portfolio publication (Phase 5.1C).
...
def _exit_code(result: PortfolioPublicationResult) -> int:
    if result.status in {
        PortfolioPublicationStatus.PUBLISHED,
        PortfolioPublicationStatus.ALREADY_PUBLISHED,
        PortfolioPublicationStatus.VALIDATED,
    }:
        return 0
    return 1
