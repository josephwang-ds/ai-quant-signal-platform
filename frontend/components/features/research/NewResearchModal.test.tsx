...
const labels: NewResearchModalLabels = {
  ...
  factorDefinitionHint: "Universe, factor, rebalance, holding period.",
  symbol: "Symbol",
  benchmark: "Benchmark",
  ...
  factorLowVol: "Low Volatility",
  factorValue: "Value",
  factorValueComingSoon: "Coming Soon",
  rebalance: "Monthly",
  ...
  errorHoldingPeriod: "Holding period must be 1–12",
  errorFactorValue: "Value factor is Coming Soon",
};
