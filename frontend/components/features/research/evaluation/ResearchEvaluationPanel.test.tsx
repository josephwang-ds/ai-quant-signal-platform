...
const labels: ResearchEvaluationLabels = {
  ...
  nextMilestonesTitle: "Next milestones",
  limitationsTitle: "Known limitations",
  blockersTitle: "Blockers",
  noBlockersTitle: "Clear to continue",
  ...
  limitationGroupEvidence: "Evidence",
  limitationGroupValidation: "Validation",
  limitationGroupRobustness: "Robustness",
  limitationGroupDeployment: "Deployment",
