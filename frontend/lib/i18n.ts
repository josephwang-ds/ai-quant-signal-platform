...
export const translations = {
  en: {
    ...
    researchListSubtitle:
      "One canonical research definition — MA Crossover on SPY. Calculated results pending real historical data.",
    ...
    researchWsNavCopilot: "Research Copilot",
    ...
    researchWsCalculatedMetrics: "Calculated backtest metrics",
    ...
    researchExpMetricsDisclaimer:
      "Metrics are not calculated in this PR. Real market data will be loaded by the Research Execution Engine. Historical research — not investment advice.",
  ...
  zh: {
    ...
    researchListSubtitle:
      "仅保留一条权威研究定义——SPY 上的 MA 均线交叉。计算结果等待真实历史数据。",
    ...
    researchWsNavCopilot: "研究 Copilot",
    ...
    researchValNotAvailable: "n/a",
    researchWsCalculatedMetrics: "计算回测指标",
    ...
    researchExpMetricsDisclaimer:
      "本 PR 不计算指标。真实市场数据将由 Research Execution Engine 加载。历史研究——不构成投资建议。",
