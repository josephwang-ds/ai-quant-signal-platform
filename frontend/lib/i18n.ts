...
export const translations = {
  en: {
    ...
    researchListModalName: "Research Name",
    researchListModalNameRequired: "Research name is required.",
    researchListModalQuestion: "Research Question",
    researchListModalLocalNote:
      "Saved in this browser. Metrics and evidence are calculated by the backend.",
    ...
    researchListModalTagsHint: "Comma-separated tags",
    ...
    researchListEmptyDescription:
      "Create a research thread, or load the MA Crossover demo to explore the workspace.",
    ...
    researchWsGuidedWorkflowTitle: "Guided research flow",
    researchWsStepRunResearch: "Run Research",
    researchWsStepValidateEvidence: "Validate Evidence",
    researchWsStepReviewEvaluation: "Review Evaluation",
    ...
    researchEvalNextGovernanceAction: "Next governance action",
  ...
  zh: {
    ...
    researchListModalName: "研究名称",
    researchListModalNameRequired: "研究名称为必填项。",
    researchListModalQuestion: "研究问题",
    researchListModalLocalNote:
      "研究定义保存在当前浏览器；指标与证据由后端真实计算。",
    ...
    researchListModalTagsHint: "逗号分隔的标签",
    ...
    researchWsGuidedWorkflowTitle: "研究工作流",
    researchWsStepRunResearch: "运行研究",
    researchWsStepValidateEvidence: "验证证据",
    researchWsStepReviewEvaluation: "审阅评估",
    ...
    researchEvalNextGovernanceAction: "下一步治理行动",
