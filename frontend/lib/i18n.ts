...
export const translations = {
  en: {
    ...
    researchListSearchPlaceholder: "Name, question, owner, tags…",
    ...
    researchListLoading: "Loading research projects…",
    researchListErrorTitle: "Research list unavailable",
    researchListRetry: "Retry",
    researchListResultCount: "projects shown",
    researchListEmptyFilterTitle: "No projects match these filters",
    ...
    researchListEmptyTitle: "No research projects yet",
    researchListEmptyDescription:
      "Start a new research thread to capture hypotheses, experiments, and validation evidence.",
    ...
    researchListArchived: "Project marked Archived locally (mock).",
    ...
    researchWsBackToList: "Back to Research Workspace",
    ...
    researchWsNotFoundDescription:
      "No mock research project matches this ID. Return to the Research Workspace list to pick a valid project.",
    researchWsNavOverview: "Overview",
    researchWsNavNotebook: "Notebook",
    researchWsNavExperiments: "Experiments",
    researchWsNavValidation: "Validation",
    researchWsNavEvaluation: "Evaluation",
    ...
    researchWsActionsDescription:
      "Actions open later PR workflows. They do not mutate research state in this mock.",
    ...
    researchValTitle: "Validation",
    researchValStageCount: "pipeline stages",
    researchValLoading: "Loading validation pipeline…",
    researchValErrorTitle: "Validation unavailable",
    researchValRetry: "Retry",
    researchValEmptyTitle: "No validation stages yet",
    researchValEmptyDescription:
      "Validation stages appear when a ValidationRun package is prepared for this research.",
    researchValFilterEmptyTitle: "No validation stages match these filters",
    researchValFilterEmptyDescription: "Clear filters or broaden your search.",
    researchValNotFoundTitle: "Validation stage not found",
    researchValNotFoundDescription:
      "No validation stage matches this ID in the current research mock catalog.",
    researchValBackToPipeline: "Back to pipeline",
    researchValRun: "Run Validation",
    researchValRunHint:
      "Deferred: governed ValidationRun workflow. Demo UI cannot execute engines.",
    researchValDemoLoading: "Demo loading state",
    researchValSearch: "Search",
    researchValSearchPlaceholder: "Stage name, purpose, result, owner…",
    researchValFilterStatus: "Status",
    researchValFilterAll: "All",
    researchValOverviewTitle: "Pipeline overview",
    researchValOverallStatus: "Overall status",
    researchValCompleted: "Completed checks",
    researchValPassed: "Passed",
    researchValFailed: "Failed",
    researchValInconclusive: "Inconclusive",
    researchValBlocking: "Blocking issues",
    researchValLastDate: "Last validation",
    researchValReadiness: "Validation readiness",
    researchValReadinessNote:
      "Readiness is a research-governance signal only — not investment advice.",
    researchValBlockersTitle: "Blocking issues",
    researchValBlockersDescription:
      "Issues that currently block research advancement toward Evaluation.",
    researchValBlockerReason: "Reason",
    researchValBlockerStage: "Affected stage",
    researchValBlockerNext: "Required next action",
    researchValBlockersEmpty: "No blocking issues in the current mock package.",
    researchValInspect: "Inspect stage",
    researchValPipelineTitle: "Validation stages",
    researchValCardPurpose: "Purpose",
    researchValCardLastRun: "Last run",
    researchValCardOwner: "Owner",
    researchValCardEvidence: "Evidence count",
    researchValCardKeyResult: "Key result",
    researchValCardWarnings: "Warnings",
    researchValCardNext: "Next action",
    researchValOpenDetail: "Open detail",
    researchValDetailTitle: "Validation detail",
    researchValDetailClose: "Close detail",
    researchValPurpose: "Purpose",
    researchValMethod: "Method",
    researchValDataset: "Dataset",
    researchValDateRange: "Date range",
    researchValBenchmark: "Benchmark",
    researchValSuccess: "Success criteria",
    researchValFalsify: "Falsification criteria",
    researchValResult: "Result",
    researchValDataConfidence: "Data confidence",
    researchValLimitations: "Limitations",
    researchValWarnings: "Warnings",
    researchValRecommendation: "Recommendation",
    researchValRunHistory: "Run history",
    researchValNextAction: "Next action",
    researchValNone: "None",
    researchValGatesTitle: "Deterministic gates",
    researchValGateRule: "Rule",
    researchValGateThreshold: "Threshold",
    researchValGateObserved: "Observed",
    researchValGateResult: "Result",
    researchValGateSeverity: "Severity",
    researchValGateEvidence: "Evidence",
    researchValGatePass: "Pass",
    researchValGateFail: "Fail",
    researchValGatesEmpty: "No gates recorded for this stage.",
    researchValGatesNote:
      "Gate outcomes are deterministic mock rules. AI must not determine Pass/Fail.",
    researchValMetricsTitle: "Metrics",
    researchValMetricsDisclaimer:
      "Historical or simulated research metrics only. Not a performance guarantee or investment advice.",
    researchValMetricHistorical: "historical",
    researchValMetricSimulated: "simulated",
    researchValEvidenceTitle: "Evidence references",
    researchValEvidenceEmpty: "No evidence references linked.",

    researchEvalTitle: "Evaluation",
    researchEvalLoading: "Loading evaluation…",
    researchEvalErrorTitle: "Evaluation unavailable",
    researchEvalRetry: "Retry",
    researchEvalEmptyTitle: "No evaluation dimensions yet",
    researchEvalEmptyDescription:
      "Evaluation dimensions appear when an Evaluation package is prepared.",
    researchEvalFilterEmptyTitle: "No dimensions match these filters",
    researchEvalFilterEmptyDescription: "Clear filters or broaden your search.",
    researchEvalMissingValidationTitle: "Missing validation data",
    researchEvalMissingValidationDescription:
      "This research has no Evaluation package yet. Complete Validation before requesting Evaluation.",
    researchEvalRequestReview: "Request Review",
    researchEvalRequestReviewHint:
      "Deferred: governed Evaluation review workflow. Demo UI cannot approve or publish.",
    researchEvalDemoLoading: "Demo loading state",
    researchEvalDemoError: "Demo error state",
    researchEvalDimensionsTitle: "Evaluation dimensions",
    researchEvalOverviewTitle: "Evaluation overview",
    researchEvalConfidenceTitle: "Research Confidence",
    researchEvalConfidenceScore: "Research Confidence score",
    researchEvalConfidenceLevel: "Confidence level",
    researchEvalConfidenceDisclaimer:
      "Research Confidence measures the quality and completeness of the research process. It is not a forecast of future returns.",
    researchEvalDemoLabel: "Simulated Evaluation",
    researchEvalResearchHealth: "Research Health",
    researchEvalDecisionReadiness: "Decision Readiness",
    researchEvalRecommendation: "Current recommendation",
    researchEvalStatus: "Evaluation status",
    researchEvalLastEvaluated: "Last evaluated",
    researchEvalLifecycle: "Strategy lifecycle stage",
    researchEvalDataConfidence: "Data confidence",
    researchEvalBlockerCount: "Number of blockers",
    researchEvalEvidenceCoverage: "Evidence coverage",
    researchEvalBreakdownTitle: "Confidence breakdown",
    researchEvalBreakdownFormula:
      "Demo formula: Σ (dimension score × weight / 100), rounded. Not a live Evaluation Engine result.",
    researchEvalBreakdownDimension: "Dimension",
    researchEvalBreakdownScore: "Score",
    researchEvalBreakdownWeight: "Weight",
    researchEvalBreakdownContribution: "Weighted contribution",
    researchEvalBreakdownStatus: "Status",
    researchEvalBreakdownTotal: "Research Confidence",
    researchEvalBreakdownWeightsTotal: "Weights total",
    researchEvalReadinessTitle: "Paper-trading readiness rules",
    researchEvalReadinessDescription:
      "Deterministic mock rules that produced the current recommendation. AI does not override these checks.",
    researchEvalReadinessRule: "Rule",
    researchEvalReadinessObserved: "Observed",
    researchEvalReadinessResult: "Result",
    researchEvalPass: "Pass",
    researchEvalFail: "Fail",
    researchEvalCriticalBlockers: "Critical blockers",
    researchEvalWarnings: "Warnings",
    researchEvalMissingEvidence: "Missing evidence",
    researchEvalSeverity: "Severity",
    researchEvalSource: "Source dimension",
    researchEvalReason: "Reason",
    researchEvalEvidence: "Evidence reference",
    researchEvalNextAction: "Required next action",
    researchEvalDue: "Due / review date",
    researchEvalEmptyBlockers: "No critical blockers.",
    researchEvalEmptyWarnings: "No warnings.",
    researchEvalEmptyMissing: "No missing-evidence items.",
    researchEvalSWTitle: "Strengths and weaknesses",
    researchEvalStrengths: "Strengths",
    researchEvalWeaknesses: "Weaknesses",
    researchEvalSWEmpty: "None recorded.",
    researchEvalRecPanelTitle: "Recommendation",
    researchEvalRecCurrent: "Current recommendation",
    researchEvalRecWhy: "Why",
    researchEvalRecBlocking: "Blocking conditions",
    researchEvalRecNext: "Required next actions",
    researchEvalRecTransition: "Eligible next lifecycle transition",
    researchEvalRecOwner: "Review owner",
    researchEvalRecReassessment: "Reassessment date",
    researchEvalNone: "None",
    researchEvalHistoryTitle: "Evaluation history",
    researchEvalHistoryDate: "Evaluation date",
    researchEvalHistoryScore: "Confidence score",
    researchEvalHistoryRec: "Recommendation",
    researchEvalHistoryChange: "Main change",
    researchEvalHistoryTrigger: "Trigger",
    researchEvalHistorySuperseded: "Superseded",
    researchEvalHistoryActive: "Current",
    researchEvalHistoryEmpty: "No prior Evaluation snapshots.",
    researchEvalSearch: "Search",
    researchEvalSearchPlaceholder: "Dimension, summary, evidence…",
    researchEvalFilterStatus: "Status",
    researchEvalFilterAll: "All",
    researchEvalEvidenceEmpty: "No evidence references.",
    researchEvalLimitations: "Limitations",
    researchEvalBlockingFlag: "Blocking",
    researchEvalBlockingYes: "Blocking",
    researchEvalBlockingNo: "No",
    researchEvalLastUpdated: "Last updated",
    researchEvalExpand: "Expand",
    researchEvalCollapse: "Collapse",
  ...
  zh: {
    ...
    researchListSearchPlaceholder: "名称、问题、负责人、标签…",
    ...
    researchListLoading: "正在加载研究项目…",
    researchListErrorTitle: "研究列表暂不可用",
    researchListRetry: "重试",
    researchListResultCount: "个项目",
    researchListEmptyFilterTitle: "没有符合筛选条件的项目",
    researchListEmptyFilterDescription: "请放宽筛选条件或清空搜索词。",
    researchListClearFilters: "清空筛选",
    researchListEmptyTitle: "尚无研究项目",
    researchListEmptyDescription:
      "创建新的研究主题，记录假设、实验与验证证据。",
    ...
    researchListArchived: "已在本地标记为归档（模拟）。",
    researchListExperimentCount: "实验数",
    ...
    researchValTitle: "验证",
    researchValStageCount: "个验证阶段",
    researchValLoading: "正在加载验证流水线…",
    researchValErrorTitle: "验证流水线暂不可用",
    researchValRetry: "重试",
    researchValEmptyTitle: "尚无验证阶段",
    researchValEmptyDescription:
      "当本研究准备 ValidationRun 包后，验证阶段会显示在此。",
    researchValFilterEmptyTitle: "没有符合筛选条件的验证阶段",
    researchValFilterEmptyDescription: "请清空筛选或放宽搜索。",
    researchValNotFoundTitle: "未找到该验证阶段",
    researchValNotFoundDescription: "当前研究的模拟目录中没有匹配此 ID 的验证阶段。",
    researchValBackToPipeline: "返回验证流水线",
    researchValRun: "运行验证",
    researchValRunHint: "延后：受治理的 ValidationRun 工作流。演示 UI 不可执行计算引擎。",
    researchValDemoLoading: "演示加载态",
    researchValSearch: "搜索",
    researchValSearchPlaceholder: "阶段名称、目的、结果、负责人…",
    researchValFilterStatus: "状态",
    researchValFilterAll: "全部",
    researchValOverviewTitle: "流水线总览",
    researchValOverallStatus: "总体状态",
    researchValCompleted: "已完成检查",
    researchValPassed: "通过",
    researchValFailed: "失败",
    researchValInconclusive: "尚无定论",
    researchValBlocking: "阻塞问题",
    researchValLastDate: "最近验证",
    researchValReadiness: "验证就绪度",
    researchValReadinessNote: "就绪度仅为研究治理信号，不构成投资建议。",
    researchValBlockersTitle: "阻塞问题",
    researchValBlockersDescription: "当前阻碍研究进入评估的问题。",
    researchValBlockerReason: "原因",
    researchValBlockerStage: "受影响阶段",
    researchValBlockerNext: "所需下一步",
    researchValBlockersEmpty: "当前模拟包中无阻塞问题。",
    researchValInspect: "查看阶段",
    researchValPipelineTitle: "验证阶段",
    researchValCardPurpose: "目的",
    researchValCardLastRun: "最近运行",
    researchValCardOwner: "负责人",
    researchValCardEvidence: "证据数量",
    researchValCardKeyResult: "关键结果",
    researchValCardWarnings: "警告",
    researchValCardNext: "下一步",
    researchValOpenDetail: "查看详情",
    researchValDetailTitle: "验证详情",
    researchValDetailClose: "关闭详情",
    researchValPurpose: "目的",
    researchValMethod: "方法",
    researchValDataset: "数据集",
    researchValDateRange: "日期区间",
    researchValBenchmark: "基准",
    researchValSuccess: "成功标准",
    researchValFalsify: "证伪标准",
    researchValResult: "结果",
    researchValDataConfidence: "数据置信度",
    researchValLimitations: "局限",
    researchValWarnings: "警告",
    researchValRecommendation: "建议",
    researchValRunHistory: "运行历史",
    researchValNextAction: "下一步",
    researchValNone: "无",
    researchValGatesTitle: "确定性闸口",
    researchValGateRule: "规则",
    researchValGateThreshold: "阈值",
    researchValGateObserved: "观测值",
    researchValGateResult: "结果",
    researchValGateSeverity: "严重度",
    researchValGateEvidence: "证据",
    researchValGatePass: "通过",
    researchValGateFail: "失败",
    researchValGatesEmpty: "该阶段尚无闸口记录。",
    researchValGatesNote: "闸口结果为确定性模拟规则。AI 不得判定通过/失败。",
    researchValMetricsTitle: "指标",
    researchValMetricsDisclaimer:
      "仅为历史或模拟研究指标，不构成业绩保证或投资建议。",
    researchValMetricHistorical: "历史",
    researchValMetricSimulated: "模拟",
    researchValEvidenceTitle: "证据引用",
    researchValEvidenceEmpty: "无关联证据引用。",

    researchEvalTitle: "评估",
    researchEvalLoading: "正在加载评估…",
    researchEvalErrorTitle: "评估暂不可用",
    researchEvalRetry: "重试",
    researchEvalEmptyTitle: "尚无评估维度",
    researchEvalEmptyDescription: "准备 Evaluation 包后将显示评估维度。",
    researchEvalFilterEmptyTitle: "没有符合筛选条件的维度",
    researchEvalFilterEmptyDescription: "请清空筛选或放宽搜索。",
    researchEvalMissingValidationTitle: "缺少验证数据",
    researchEvalMissingValidationDescription:
      "该研究尚无 Evaluation 包。请先完成验证再请求评估。",
    researchEvalRequestReview: "请求评审",
    researchEvalRequestReviewHint:
      "延后：受治理的评估评审工作流。演示 UI 不可批准或发布。",
    researchEvalDemoLoading: "演示加载态",
    researchEvalDemoError: "演示错误态",
    researchEvalDimensionsTitle: "评估维度",
    researchEvalOverviewTitle: "评估总览",
    researchEvalConfidenceTitle: "研究置信度",
    researchEvalConfidenceScore: "研究置信度分数",
    researchEvalConfidenceLevel: "置信度等级",
    researchEvalConfidenceDisclaimer:
      "研究置信度衡量研究过程的质量与完整性，不是未来收益的预测。",
    researchEvalDemoLabel: "模拟评估",
    researchEvalResearchHealth: "研究健康度",
    researchEvalDecisionReadiness: "决策就绪度",
    researchEvalRecommendation: "当前建议",
    researchEvalStatus: "评估状态",
    researchEvalLastEvaluated: "最近评估",
    researchEvalLifecycle: "策略生命周期阶段",
    researchEvalDataConfidence: "数据置信度",
    researchEvalBlockerCount: "阻塞项数量",
    researchEvalEvidenceCoverage: "证据覆盖率",
    researchEvalBreakdownTitle: "置信度分解",
    researchEvalBreakdownFormula:
      "演示公式：Σ（维度分数 × 权重 / 100）后四舍五入。非线上评估引擎结果。",
    researchEvalBreakdownDimension: "维度",
    researchEvalBreakdownScore: "分数",
    researchEvalBreakdownWeight: "权重",
    researchEvalBreakdownContribution: "加权贡献",
    researchEvalBreakdownStatus: "状态",
    researchEvalBreakdownTotal: "研究置信度",
    researchEvalBreakdownWeightsTotal: "权重合计",
    researchEvalReadinessTitle: "模拟盘就绪规则",
    researchEvalReadinessDescription:
      "产生当前建议的确定性模拟规则。AI 不得覆盖这些检查。",
    researchEvalReadinessRule: "规则",
    researchEvalReadinessObserved: "观测值",
    researchEvalReadinessResult: "结果",
    researchEvalPass: "通过",
    researchEvalFail: "失败",
    researchEvalCriticalBlockers: "关键阻塞",
    researchEvalWarnings: "警告",
    researchEvalMissingEvidence: "缺失证据",
    researchEvalSeverity: "严重度",
    researchEvalSource: "来源维度",
    researchEvalReason: "原因",
    researchEvalEvidence: "证据引用",
    researchEvalNextAction: "所需下一步",
    researchEvalDue: "到期 / 复审日期",
    researchEvalEmptyBlockers: "无关键阻塞。",
    researchEvalEmptyWarnings: "无警告。",
    researchEvalEmptyMissing: "无缺失证据项。",
    researchEvalSWTitle: "优势与弱点",
    researchEvalStrengths: "优势",
    researchEvalWeaknesses: "弱点",
    researchEvalSWEmpty: "暂无记录。",
    researchEvalRecPanelTitle: "建议",
    researchEvalRecCurrent: "当前建议",
    researchEvalRecWhy: "原因",
    researchEvalRecBlocking: "阻塞条件",
    researchEvalRecNext: "所需下一步",
    researchEvalRecTransition: "可进入的下一生命周期转换",
    researchEvalRecOwner: "评审负责人",
    researchEvalRecReassessment: "复评日期",
    researchEvalNone: "无",
    researchEvalHistoryTitle: "评估历史",
    researchEvalHistoryDate: "评估日期",
    researchEvalHistoryScore: "置信度分数",
    researchEvalHistoryRec: "建议",
    researchEvalHistoryChange: "主要变化",
    researchEvalHistoryTrigger: "触发",
    researchEvalHistorySuperseded: "已替代",
    researchEvalHistoryActive: "当前",
    researchEvalHistoryEmpty: "尚无历史评估快照。",
    researchEvalSearch: "搜索",
    researchEvalSearchPlaceholder: "维度、摘要、证据…",
    researchEvalFilterStatus: "状态",
    researchEvalFilterAll: "全部",
    researchEvalEvidenceEmpty: "无证据引用。",
    researchEvalLimitations: "局限",
    researchEvalBlockingFlag: "是否阻塞",
    researchEvalBlockingYes: "阻塞",
    researchEvalBlockingNo: "否",
    researchEvalLastUpdated: "最近更新",
    researchEvalExpand: "展开",
    researchEvalCollapse: "收起",
