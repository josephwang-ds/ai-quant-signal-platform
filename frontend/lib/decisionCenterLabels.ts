...
export function buildDecisionCenterLabels(
  ...
  return {
    ...
    outcomePromote: tr("decisionRecordPromote"),
    outcomeHold: tr("decisionRecordHold"),
    outcomeReject: tr("decisionRecordReject"),
    outcomeArchive: tr("decisionRecordArchive"),
    rationaleLabel: tr("decisionRecordRationale"),
    rationalePlaceholder: tr("decisionRecordRationalePlaceholder"),
    evidenceSummaryLabel: tr("decisionRecordEvidenceSummary"),
    evidenceSummaryPlaceholder: tr("decisionRecordEvidenceSummaryPlaceholder"),
    reviewerNoteLabel: tr("decisionRecordReviewerNote"),
    reviewerNotePlaceholder: tr("decisionRecordReviewerNotePlaceholder"),
    saveDecision: tr("decisionRecordSave"),
    savedDecision: tr("decisionRecordSaved"),
    localNote: tr("decisionRecordLocalNote"),
    humanDecisionNote: tr("decisionRecordHumanNote"),
